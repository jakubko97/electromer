...
const routes: Routes = [
  ...
  { path: 'list', loadChildren: () => import('src/app/pages/list/list.module').then(m => m.ListPageModule), canActivate: [AdminGuard] },
  { path: 'users', loadChildren: () => import('src/app/pages/users/users.module').then(m => m.UsersPageModule), canActivate: [AdminGuard] },
